      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {TESTIMONIALS_CONTENT.map((testimonial, index) => (
          <motion.div
            ...
            className="bg-white dark:bg-dark-card p-8 rounded-3xl border border-slate-200 dark:border-dark-border shadow-sm hover:shadow-xl transition-all duration-500 relative"
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-8 italic leading-relaxed relative z-10">
              "{testimonial.quote}"
            </p>
