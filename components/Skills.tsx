            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
              {category.skills.map((skill) => (
                <div key={skill.name} className="flex flex-col items-center gap-2 group">
                  <div className="p-4 bg-white dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-800 transition-all duration-300 group-hover:bg-accent/10 dark:group-hover:bg-dark-accent/20 group-hover:border-accent dark:group-hover:border-dark-accent">
